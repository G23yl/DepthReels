...
from skyreels_v2.pipelines import PromptEnhancer, Image2VideoDepth2Pipeline
...
if __name__ == "__main__":
    ...
    pipe = Image2VideoDepth2Pipeline(
    ...
    sample = RoboDepth(data_root="/mnt/zhouxin-mnt", max_num_frames=49)[0]
